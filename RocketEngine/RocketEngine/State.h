...
namespace RocketEngine
{
	...
	public:
		...
		RocketCore::Graphics::AnimDesc GetAnimDesc();
		RocketCore::Graphics::AnimData GetAnimData();
		RocketCore::Graphics::AnimData& GetAnimDataRef();

	private:
		RocketCore::Graphics::AnimDesc _animDesc;
		RocketCore::Graphics::AnimData _animData;
	};
}
