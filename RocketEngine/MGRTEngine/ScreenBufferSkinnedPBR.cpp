...
{
	ScreenBufferSkinnedPBR::ScreenBufferSkinnedPBR(Shader* belongShader) : ScreenBuffer(belongShader)
	{
		//
	}

	void ScreenBufferSkinnedPBR::Initialize(ID3DX11EffectTechnique* quadTech)
	{
	...
	void ScreenBufferSkinnedPBR::AssignRequiredDeferredPBRVariables(const std::string& albedoGVal, const std::string& normalGVal, const std::string& positionGVal, const std::string& armGVal, const std::string& depthGVal)
	{
	...
	void ScreenBufferSkinnedPBR::UseQuadLayout()
	{
